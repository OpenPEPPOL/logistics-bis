...
docker run --rm -i -v $PROJECT:/src --entrypoint java klakegg/saxon:9.8.0-7 -cp /saxon.jar net.sf.saxon.Transform -s:/src/structure/syntax/ebxml-search-notice-request.xml -xsl:/src/tools/create-ebxml-example-from-syntax.xsl -o:/src/rules/examples/T011/ExampleSearchNoticeRequest.xml

echo "Generating ebXML example: Search Notice Response (T012)"
docker run --rm -i -v $PROJECT:/src --entrypoint java klakegg/saxon:9.8.0-7 -cp /saxon.jar net.sf.saxon.Transform -s:/src/structure/syntax/ebxml-search-notice-response.xml -xsl:/src/tools/create-ebxml-example-from-syntax.xsl -o:/src/rules/examples/T012/ExampleSearchNoticeResponse.xml
...
docker run --rm -i -v $PROJECT:/src --entrypoint java klakegg/saxon:9.8.0-7 -cp /saxon.jar net.sf.saxon.Transform -s:/src/structure/syntax/ebxml-publish-notice.xml -xsl:/src/tools/create-ebxml-example-from-syntax.xsl -o:/src/rules/examples/T015/ExamplePublishNotice.xml
