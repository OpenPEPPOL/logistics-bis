...
Consumer unit quantity (Item/PackSizeNumeric)::
...
----
include::{snippet-dir}/Snippet-1.xml[tags=quantity-4]
----
====
...
----
include::{snippet-dir}/Snippet-1.xml[tags=quantity-2]
----
====
...
.Example
----
include::{snippet-dir}/Snippet-1.xml[tags=catch]
----
