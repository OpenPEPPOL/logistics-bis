...
container.
This value will be evaluated against codelists, and only if using values that are in the codelist they will be accepted as valid. 
The codelist used for “EndpointID” is “EAS” (Electronic Address Scheme) and för “ID” in the “PartyIdentification”-container the 
codelist is “ICD” (ISO 6523).

.Examples of usage in PartyIdentification
[source, xml]
----
include::{snippet-dir}/Snippet-2.xml[tags=party-id]
----
...
[source, xml]
----
include::{snippet-dir}/Snippet-2.xml[tags=epid]
----
