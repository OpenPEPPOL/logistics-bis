...
in the https://test-vefa.difi.no/peppolbis/pracc/catalogue/1.0/syntax/catalogue/tree[syntax mapping] rules valid for specific elements or attributes are listed. 
