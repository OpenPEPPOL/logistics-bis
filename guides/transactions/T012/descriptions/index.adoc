...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[lines=2..16]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[tags=specification-identification]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[tags=business-process-type-identifier]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[tags=issue-date-time]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[tags=sender-electronic-address]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[tags=receiver-electronic-address]
....
<.> The scheme of the endpoint id is clarified in the type attribute of the slot.
...
[source,xml,indent=0]
....
include::{snippets-dir}/ExampleSearchNoticeResponse.xml[tags=registry-object-list]
....
...
<.> Electronic address according to {link-eas} used by the buyer, just like the ones from the receiver or sender.
<.> This is the UBL code of the type of document you searched for. Possible values can be taken from the list {link-codelist} ublDocumentSchema/[ublDocumentSchema], which has to be identified in the type-attribute of the slot.
