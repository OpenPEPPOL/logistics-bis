...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=ublVersionID]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=id]
....
...
.Example of document identifier
....
include::{snippets-dir}/NotifyAwarding.xml[tags=contractFolderID]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=issueDateTime]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=senderParty]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=receiverParty]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=note]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=tenderReference]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=tenderResultCode]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=awardDateTime]
....
<.> Format for the date has to be yyyy-mm-dd
<.> Format for the time has to be hh:mm:ssTZD, granularity down to seconds and timezone
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=startDate]
....
<.> Format for the date has to be yyyy-mm-dd
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=contract]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=awardedTenderedProject]
....
...
....
include::{snippets-dir}/NotifyAwarding.xml[tags=winningParty]
....
