...
// local links
:link-main-site: link:/pracc/{git-branch}[Main documentation site]
:main-site: link:../../[Main documentation site]

// :link-mapping: link:/pracc/{git-branch}syntax/{name-syntax}/tree/[Syntax mapping for {name-transaction}]
:link-mapping: link:/{Main documentation site}/syntax/{name-syntax}/tree/[Syntax mapping for {name-transaction}]
