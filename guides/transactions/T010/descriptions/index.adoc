...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderClarification-doc.xml[tags=ref-contract-folder-id;ref-answer;answer]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderClarification-doc.xml[tags=ref-contract-folder-id;ref-file;file]
....
