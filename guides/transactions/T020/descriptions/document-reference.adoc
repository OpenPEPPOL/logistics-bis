...
----
include::{xml-snippets-file}[tags=QualificationDocument]
----
...
----
include::{xml-snippets-file}[tags=TenderDocumentReference]
----
...
.Document Type Code
----
include::{xml-snippets-file}[tags=DocumentTypeCode]
----
