...
[source,xml,indent=0]
.Example of using the contracting body's electronic address identifier in `cac:SenderParty`
----
<cac:SenderParty>
...
----
[source,xml,indent=0]
.Example of using the economic operator's electronic address identifier in `cac:ReceiverParty`
----
<cac:ReceiverParty>
...
----
<cbc:ProfileID>urn:fdc:peppol.eu:prac:bis:p012:1.0</cbc:ProfileID>
...
----
<cbc:CustomizationID>urn:fdc:peppol.eu:prac:trns:t023:1.0</cbc:CustomizationID>
