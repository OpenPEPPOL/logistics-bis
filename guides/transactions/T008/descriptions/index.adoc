...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderingAnswers-doc.xml[tags=ref-contract-folder-id;refer-questions-procurement-procedure;questions-procurement-procedure]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderingAnswers-doc.xml[tags=ref-contract-folder-id;multiple-questions-group-of-lots;question-group-of-lots]
....
<.> The Contract Folder ID of the procurement procedure.
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderingAnswers-doc.xml[tags=ref-contract-folder-id;refer-one-question-for-multiple-lots;one-question-for-multiple-lots]
....
<.> The Contract Folder ID of the procurement procedure.
<.> Referencing a lot.
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderingAnswers-doc.xml[tags=refer-multiple-attachments;multiple-attachments]
....
