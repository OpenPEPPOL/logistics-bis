...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=specification-identification]
....
<.> The value for the specification identification is always "_urn:fdc:peppol.eu:prac:trns:t013:1_".
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=business-process-type-identifier]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=document-identifier]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=reference-number]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=received-document-reference]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=document-digest]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=tender-notification-document-reference]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=contracting-party]
....
...
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=tenderer-party]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=tenderer-party-contact]
....
...
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=document-date-time]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawal.xml[tags=withdraw-offer-indicator]
....
