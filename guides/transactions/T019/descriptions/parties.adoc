...
----
include::{snippets-dir}/Qualification-doc.xml[tags=MainQualifyingParty]
----
...
The response to a T019 - Qualification, a T020 - Qualification Reception Confirmation must be returned to the Main Qualifying Party.
...
----
include::{snippets-dir}/Qualification-doc.xml[tags=ContractingParty]
----
...
[source,xml,indent=0]
----
include::{snippets-dir}/Qualification-doc.xml[tags=InterestedProcurementProjectLot]
----
