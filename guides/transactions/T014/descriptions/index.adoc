...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=specification-identification]
....
<.> The value for the specification identification is always "_urn:fdc:peppol.eu:prac:trns:t014:1:2_".
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=business-process-type-identifier]
....
<.> The value for the business process type identifier is always "_urn:fdc:peppol.eu:prac:bis:p007:1:2_".
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=document-identifier]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=reference-number]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=received-document-reference]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[lines=39]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=document-digest]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=rem-evidence-reference]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=issuer-party]
....
...
[source,xml,indent=0]
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=economic-operator]
....
...
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=contracting-body]
....
...
....
include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=document-issue-time-date]

include::{snippets-dir}/TenderWithdrawalReceptionNotification.xml[tags=document-reception-time-date]
....
