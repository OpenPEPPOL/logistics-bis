...
....
<.> The value for the specification identification is always "_urn:fdc:peppol.eu:prac:trns:t014:1_".
...
....
<.> The value for the business process type identifier is always "_urn:fdc:peppol.eu:prac:bis:p007_".
