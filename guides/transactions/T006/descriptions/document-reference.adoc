...
----
include::{xml-snippets-file}[tags=DocumentHash]
----
////
...
----
include::{xml-snippets-file}[tags=HashAlgorithmMethod]
----
...
----
include::{xml-snippets-file}[tags=TenderDocumentReference1]
----
...
----
include::{xml-snippets-file}[tags=TenderDocumentReference2]
----
...
.Document Type Code
----
include::{xml-snippets-file}[tags=DocumentTypeCode1]
----
...
[source,xml,indent=0]
....
include::{xml-snippets-file}[tags=IssuerParty]
....
...
.Document Type Code
----
include::{xml-snippets-file}[tags=DocumentTypeCode2]
----
...
[source,xml,indent=0]
....
include::{xml-snippets-file}[tags=IssuerParty2]
....
