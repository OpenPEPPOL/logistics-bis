...
[source,xml,indent=0]
----
include::{xml-snippets-file}[tags=ContractFolderID]
----
...
[source,xml,indent=0]
----
include::{xml-snippets-file}[tags=DocumentReference1]
----
...
[source,xml,indent=0]
----
include::{xml-snippets-file}[tags=DocumentReference2]
----
...
----
include::{xml-snippets-file}[tags=Provided_ESPD]
----
