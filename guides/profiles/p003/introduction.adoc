...
The {name-profile} describes electronic messaging support for the business process of an economic operator submitting electronic tender to a contracting body, as a response to a call for tender. The contracting body notifies the economic operator of having received the tender.
