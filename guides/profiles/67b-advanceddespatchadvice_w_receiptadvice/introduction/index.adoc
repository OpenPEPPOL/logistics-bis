...
This BIS (Business Interoperability Specification) is a result of work within BEAst Supply 4.0 Project and Peppol Logistics Incubation Project.
After the incubation project it will be part of the specifications in new Logistics domain in OpenPeppol.
