...
include::../../67b-advanceddespatchadvice_w_receiptadvice/principles/parties.adoc[]

include::../../67b-advanceddespatchadvice_w_receiptadvice/principles/otherconcepts.adoc[]
