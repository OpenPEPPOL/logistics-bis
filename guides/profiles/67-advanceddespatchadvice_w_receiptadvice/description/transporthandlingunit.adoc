...
It is not allowed to show only some Transport Handling Units. If the ID has the format of an SSCC, the attribute @schemeID should be included to indicate it.
