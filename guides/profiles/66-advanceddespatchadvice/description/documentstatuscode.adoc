...
If the Despatch Advice is rejected by the network or the receiver, indicating that the receiver did not receive it, the next transmission of the DEsptch Advice should still be considdered as the first ona, and the code 9 should still be used.
