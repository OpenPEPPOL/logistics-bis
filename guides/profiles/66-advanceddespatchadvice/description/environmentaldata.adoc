...
To be able to calculate product climate data the related CO2 value is needed and the weight of products are needed. 
The net weight per despatch line is one recommended way to provide the weight information to the customer.
(insert code related to line weight)
...
(insert code related to Buyers item identification)
...
Environmental Product Declaration (EPD) provides specific CO2 data related to the product.
