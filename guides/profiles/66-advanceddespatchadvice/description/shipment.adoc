...
If you need to specify more than one license plate number, use a hashtag (#) between the license plate id:s. Place the License plate id of the truck 
...
It is also an option to include additional information about the vehicle's maximum load capacity. Please see how this is done in the example below. 
The code ABT means "Payload weight maximum."
