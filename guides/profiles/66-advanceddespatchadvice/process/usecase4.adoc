[[use-case-4-Service]]
== Use case 4 – Services provided with a vehicle that should be billed or reported in some way
...
|====
|*Use Case number* |4
|*Use Case Name* |Services provided with a vehicle that should be billed or reported in some way
