[[use-case-5-services-between-two-locations-without-vehicle]]
== Use case 5 – Despatch Advice for services between two locations, without vehicle
...
|====
|*Use Case number* |5
|*Use Case Name* |Despatch Advice for services between two locations, with vehicle that should not be billed or reported in any way
