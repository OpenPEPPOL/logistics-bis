...
[cols="1,4,1",options="header, autowidth",stripes=even]
|====
...
|*8* |Despatch Advice for waste treatment service, no transport.                                                     |link:#use_case_8_despatch_advice_for_waste_treatment_service_no_transport[Link to use case 8]
|*9* |Despatch Advice for waste treatment service, including the transport.                                          |link:#use_case_9_despatch_advice_for_waste_treatment_service_including_the_transport[Link to use case 9]
