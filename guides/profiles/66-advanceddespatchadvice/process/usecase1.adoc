...
Describes a complete process whereby a Despatch party generates a Despatch Advice containing information about the goods that is ready to be picked up, but no information about the transport since it is not known yet. 
