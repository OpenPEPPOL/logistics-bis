...
based on the {link-bii3} and the work done by {link-esens} eTendering:

* {link-profile}
* {link-profile2}

NOTE: The {link-bii3} profile document is available from your national standardization body.
...
include::encryption-certificate.adoc[]
