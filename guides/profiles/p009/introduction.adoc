...
The {name-profile} describes a process providing electronic messaging support for the business process of notification by a contracting body that a contract has been awarded to a particular economic operator.
