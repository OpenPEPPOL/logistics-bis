...
The Transportation Status Request data model is bound to {ubl24} of the document type {ubl-transportation-status-request}. The target namespace for the UBL2.4 TransportationStatusRequest is:
*urn:oasis:names:specification:ubl:schema:xsd:TransportationStatusRequest-2*

The Transportation Status data model is bound to {ubl24} of the document type {ubl-transportation-status}. The target namespace for the UBL2.4 TransportationStatus is:
*urn:oasis:names:specification:ubl:schema:xsd:TransportationStatus-2*

The Application Response data model is bound to {ubl24} of the document type {ubl-application-response}. The target namespace for the UBL2.4 ApplicationResponse is:
