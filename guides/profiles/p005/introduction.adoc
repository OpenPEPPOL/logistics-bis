...
The {name-profile} describes a process providing electronic messaging support for the business process of answering questions of contracting authorities about a tender. Thus, this profile supports the contracting authority to clarify questions on a tender which has been submitted by an economic operator.
