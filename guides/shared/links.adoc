...
:description: The PEPPOL Business Interoperability Specification, “BIS” from here on after, has been developed by the Peppol Logistics Incubation Project and is published as part of the PEPPOL specifications.
...
:main-site: link:/4.0/[Main documentation site]
...
:ubl-transport-execution-plan-request: http://docs.oasis-open.org/ubl/os-UBL-2.3/xsd/maindoc/UBL-TransportExecutionPlanRequest-2.3.xsd[UBL Transport Execution Plan Request 2.3]
:ubl-transport-execution-plan: http://docs.oasis-open.org/ubl/os-UBL-2.3/xsd/maindoc/UBL-TransportExecutionPlan-2.3.xsd[UBL Transport Execution Plan 2.3]
