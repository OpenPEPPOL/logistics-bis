...
:openpeppol: https://peppol.org/about-openpeppol/?rel=tab41[OpenPEPPOL]
:policy8: https://peppol.org/downloads/the-peppol-edelivery-network-specifications/[PEPPOL Policy for identifiers, policy 8]
...
:main-site: link:/logistics[Main documentation site]
...
:codelist-ItemPropertyNameCode: link:/codelist/ItemPropertyNameCode/[Item Property Name Code list]