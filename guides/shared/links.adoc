...
:examples-zip: http://bis.beast.se/4.0/files/Beast-Examples.zip[Example files (ZIP)]

//internal
:link-codelist: link:/4.0/codelist/[Code list section]
:codelist-ICD: link:/4.0/codelist/ICD/[ICD codes]
:codelist-EAS: link:/4.0/codelist/eas/[EAS codes]
:vat-codes: link:/4.0/codelist/UNCL5305/[Code list UNCL5305]
:mime-codes: link:/4.0/codelist/MimeCode/[Mime codes]
