...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="cac:Shipment/cac:TransportHandlingUnit">
		<assert id="PEPPOL-T128-R027" test="((normalize-space(cac:Status/cbc:ConditionCode) = '5') and not(cbc:DamageRemarks)) or (not(normalize-space(cac:Status/cbc:ConditionCode) = '5') and (cbc:DamageRemarks))" flag="fatal">If the Condition Code on the Transport Handling Unit is not ok, a Damage Remarks SHALL be provided.</assert>
	</rule>
</pattern>
