...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="cbc:ProfileID">
		<assert id="PEPPOL-T128-R002"
				...
				flag="fatal">ProfileID SHALL have the value urn:fdc:peppol.eu:logistics:bis:receipt_advice_only:1 OR urn:fdc:peppol.eu:logistics:bis:despatch_advice_w_receipt_advice:1.</assert>
	</rule>
</pattern>
