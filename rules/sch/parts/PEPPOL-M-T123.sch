...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="cac:Consignment">
		...
		<assert id="PEPPOL-T123-R008" test="not(cbc:GrossWeightMeasure) and not(cbc:GrossVolumeMeasure) and not(cbc:LoadingLengthMeasure)" flag="warning">Either grossweight, gossvolumen or loadinglength must be specified</assert>
