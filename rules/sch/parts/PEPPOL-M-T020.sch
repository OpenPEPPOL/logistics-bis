...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="ubl:TenderReceipt/cbc:CustomizationID">
        <assert id="PEPPOL-T020-R002" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t020:1:2'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t020:1:2'</assert>
    ...
    <rule context="ubl:TenderReceipt/cbc:ProfileID">
        <assert id="PEPPOL-T020-R003" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p011:1:2'">ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p003:1.3'</assert>
