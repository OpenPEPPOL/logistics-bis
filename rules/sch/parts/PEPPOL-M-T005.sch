...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="ubl:Tender/cbc:CustomizationID">
        <assert id="PEPPOL-T005-R010" flag="fatal" test="normalize-space(.) = ('urn:fdc:peppol.eu:prac:trns:t005:1.3','urn:fdc:peppol.eu:prac:trns:t005:1.3')">[PEPPOL-T005-R010] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t005:1.3' or 'urn:fdc:peppol.eu:prac:trns:t005:1.3'</assert>
    ...
    <rule context="ubl:Tender/cbc:ProfileID">
        <assert id="PEPPOL-T005-R011" flag="fatal" test="normalize-space(.) = ('urn:fdc:peppol.eu:prac:bis:p003:1.3','urn:fdc:peppol.eu:prac:bis:p003:1.3')">[PEPPOL-T005-R011] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p003:1.3' or 'urn:fdc:peppol.eu:prac:bis:p003:1.3'</assert>
    ...
    <rule context="ubl:Tender/cac:DocumentReference/cac:Attachment">
        <assert id="PEPPOL-T005-R023" flag="fatal" test="exists(cac:ExternalReference/cbc:DocumentHash)">[PEPPOL-T005-R023] An Attachment MUST have a document hash</assert>
        <assert id="PEPPOL-T005-R024" flag="fatal" test="exists(cac:ExternalReference/cbc:HashAlgorithmMethod)">[PEPPOL-T005-R024] An Attachment MUST have a hash algorithm method</assert>
        <assert id="PEPPOL-T005-R025" flag="fatal" test="normalize-space(cac:ExternalReference/cbc:HashAlgorithmMethod) = 'http://www.w3.org/2001/04/xmlenc#sha256'">[PEPPOL-T005-R025] Hash Algorithm MUST be SHA-256 (http://www.w3.org/2001/04/xmlenc#sha256)</assert>
    </rule>
