...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="ubl:Tender/cac:DocumentReference/cac:Attachment">
        ...
        <assert id="PEPPOL-T005-R024" flag="fatal" test="exists(cacExternalReferencec/cbc:HashAlgorithmMethod)">[PEPPOL-T005-R024] An Attachment MUST have a hash algorithm method</assert>
