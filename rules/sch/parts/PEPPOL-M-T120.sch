...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="cac:AdditionalDocumentReference">
		<assert id="PEPPOL-T120-R031" test="(cbc:DocumentTypeCode) or (cac:cbc:DocumentType)" flag="fatal">AdditionalDocumentReference SHALL contain a Document Type Code or a Document Type. </assert>
	</rule>
	<rule context="cac:DespatchLine/cac:DocumentReference">
		<assert id="PEPPOL-T120-R032" test="(cbc:DocumentTypeCode) or (cac:cbc:DocumentType)" flag="fatal">DocumentReference (Despatch Line) SHALL contain a Document Type Code or a Document Type. </assert>
	</rule>
</pattern>