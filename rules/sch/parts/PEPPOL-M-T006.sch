...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="ubl:TenderReceipt">
        ...
        <rule context="ubl:TenderReceipt/cbc:CustomizationID">
            <assert id="PEPPOL-T006-R002" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t006:1.3'">[PEPPOL-T006-R002] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t006:1.3'</assert>
        ...
        <rule context="ubl:TenderReceipt/cbc:ProfileID">
            <assert id="PEPPOL-T006-R003" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p003:1.3'">[PEPPOL-T006-R003] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p003:1.3'</assert>
