...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="ubl:UnsubscribeFromProcedureResponse/cbc:CustomizationID">
        <assert id="PEPPOL-T022-R002" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t022:1.3'">[PEPPOL-T022-R002] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t022:1.3'</assert>
    ...
    <rule context="ubl:UnsubscribeFromProcedureResponse/cbc:ProfileID">
        <assert id="PEPPOL-T022-R004" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p001:1.3'">[PEPPOL-T022-R004] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p001:1.3'</assert>
