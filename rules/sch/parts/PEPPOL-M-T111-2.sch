...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="cac:Status[cbc:StatusReasonCode/@listID='OPStatusAction']">
		<assert id="PEPPOL-T111-R006"
				...
				flag="fatal">[PEPPOL-T111-R006]-Clarification Reason code shall exist in the OPStatusAction code lists as identified by listID.</assert>
	</rule>
	...
	<rule context="cac:Status[cbc:StatusReasonCode/@listID='OPStatusReason']">
		<assert id="PEPPOL-T111-R007"
				...
				flag="fatal">[PEPPOL-T111-R007]-Clarification Reason code shall exist in the OPStatusReason code lists as identified by listID.</assert>
	</rule>
