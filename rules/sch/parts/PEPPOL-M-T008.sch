...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="ubl:EnquiryResponse/cbc:CustomizationID">
        <assert id="PEPPOL-T008-R009" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t008:1.2'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t008:1.2'</assert>
    ...
    <rule context="ubl:EnquiryResponse/cbc:ProfileID">
        <assert id="PEPPOL-T008-R010" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p004:1.2'">ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p004:1.2'</assert>
