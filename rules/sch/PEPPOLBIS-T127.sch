...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:u="utils" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <ns uri="urn:oasis:names:specification:ubl:schema:xsd:TransportationStatus-2" prefix="ubl"/>
    ...
    <include href="../../target/generated/T127-basic.sch"/>
    <include href="parts/PEPPOL-M-T127.sch"/>    
