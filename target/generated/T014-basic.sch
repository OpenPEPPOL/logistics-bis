...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
    <let name="cleas" value="tokenize('0002 0007 0009 0037 0060 0088 0096 0097 0106 0130 0135 0142 0151 0177 0183 0184 0188 0190 0191 0192 0193 0195 0196 0198 0199 0200 0201 0202 0204 0208 0209 0210 0211 0212 0213 0215 0216 0218 0221 0230 0235 9910 9913 9914 9915 9918 9919 9920 9922 9923 9924 9925 9926 9927 9928 9929 9930 9931 9932 9933 9934 9935 9936 9937 9938 9939 9940 9941 9942 9943 9944 9945 9946 9947 9948 9949 9950 9951 9952 9953 9957 9959 0147 0154 0158 0170 0194 0203 0205 0217 0225 0240 0244', '\s')"/>
    ...
    <rule context="/ubl:TenderReceipt">
        ...
        <assert test="cac:TenderDocumentReference" flag="fatal" id="PEPPOL-T014-B00110">Element 'cac:TenderDocumentReference' MUST be provided.</assert>
    ...
    <rule context="/ubl:TenderReceipt/cbc:UBLVersionID">
        <assert test="normalize-space(text()) = '2.2'" flag="fatal" id="PEPPOL-T014-B00201">Element 'cbc:UBLVersionID' MUST contain value '2.2'.</assert>
    </rule>
    <rule context="/ubl:TenderReceipt/cbc:CustomizationID">
        <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t014:1'" flag="fatal" id="PEPPOL-T014-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t014:1'.</assert>
    </rule>
    <rule context="/ubl:TenderReceipt/cbc:ProfileID">
        <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p007'" flag="fatal" id="PEPPOL-T014-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p007'.</assert>
    </rule>
    <rule context="/ubl:TenderReceipt/cbc:ID">
        <assert test="not(@schemeURI) or @schemeURI = 'urn:uuid'" flag="fatal" id="PEPPOL-T014-B00501">Attribute 'schemeURI' MUST contain value 'urn:uuid'</assert>
    ...
    <rule context="/ubl:TenderReceipt/cac:TenderDocumentReference/cbc:ID">
        <assert test="not(@schemeURI) or @schemeURI = 'urn:uuid'" flag="fatal" id="PEPPOL-T014-B01301">Attribute 'schemeURI' MUST contain value 'urn:uuid'</assert>
    ...
    <rule context="/ubl:TenderReceipt/cac:TenderDocumentReference/cbc:DocumentTypeCode">
        <assert test="normalize-space(text()) = '13 or 310'" flag="fatal" id="PEPPOL-T014-B01501">Element 'cbc:DocumentTypeCode' MUST contain value '13 or 310'.</assert>
        <assert test="not(@listID) or @listID = 'UNCL1001'" flag="fatal" id="PEPPOL-T014-B01502">Attribute 'listID' MUST contain value 'UNCL1001'</assert>
    ...
    <rule context="/ubl:TenderReceipt/cac:TenderDocumentReference/cac:Attachment/cac:ExternalReference/cbc:HashAlgorithmMethod">
        <assert test="normalize-space(text()) = 'http://www.w3.org/2001/04/xmlenc#sha256'" flag="fatal" id="PEPPOL-T014-B02001">Element 'cbc:HashAlgorithmMethod' MUST contain value 'http://www.w3.org/2001/04/xmlenc#sha256'.</assert>
    </rule>
    <rule context="/ubl:TenderReceipt/cac:TenderDocumentReference/cac:Attachment/cac:ExternalReference/*">
    ...
    <rule context="/ubl:TenderReceipt/cac:SenderParty/cbc:EndpointID">
        <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)" flag="fatal" id="PEPPOL-T014-B02501">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
    </rule>
    ...
    <rule context="/ubl:TenderReceipt/cac:SenderParty/cac:PartyIdentification/cbc:ID">
        <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)" flag="fatal" id="PEPPOL-T014-B02801">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
    </rule>
    ...
    <rule context="/ubl:TenderReceipt/cac:ReceiverParty/cbc:EndpointID">
        ...
        <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)" flag="fatal" id="PEPPOL-T014-B03302">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
    </rule>
    ...
    <rule context="/ubl:TenderReceipt/cac:ReceiverParty/cac:PartyIdentification/cbc:ID">
        ...
        <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)" flag="fatal" id="PEPPOL-T014-B03602">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
    </rule>
