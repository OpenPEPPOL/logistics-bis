<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:Enquiry/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t007:1'"
                 flag="fatal"
                 id="PEPPOL-T007-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t007:1'.</assert>
      </rule>
      ...
      <rule context="ubl:Enquiry">
        ...
        <rule context="ubl:Enquiry/cbc:CustomizationID">
            <assert id="PEPPOL-T007-R011"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t007:1'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t007:1'</assert>
