<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:TendererQualification/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t019:1:2'"
                 flag="fatal"
                 id="PEPPOL-T019-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t019:1:2'.</assert>
      </rule>
      <rule context="/ubl:TendererQualification/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p011:1:2'"
                 flag="fatal"
                 id="PEPPOL-T019-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p011:1:2'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:TendererQualification/cbc:CustomizationID">
        <assert id="PEPPOL-T019-R015"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t019:1:2'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t019:1:2'</assert>
