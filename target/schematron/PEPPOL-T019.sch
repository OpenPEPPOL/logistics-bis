<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:TendererQualification/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t019:1'"
                 flag="fatal"
                 id="PEPPOL-T019-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t019:1'.</assert>
      </rule>
      <rule context="/ubl:TendererQualification/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p011'"
                 flag="fatal"
                 id="PEPPOL-T019-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p011'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:TendererQualification/cbc:UBLVersionID">
        ...
        <assert id="PEPPOL-T019-R014" flag="warning" test="not(./@*)">
      ...
      <rule context="ubl:TendererQualification/cbc:CustomizationID">
        <assert id="PEPPOL-T019-R015"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t019:1'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t019:1'</assert>
        <assert id="PEPPOL-T019-R016" flag="warning" test="not(./@*)">
      ...
      <rule context="ubl:TendererQualification/cbc:ProfileID">
        <assert id="PEPPOL-T019-R017"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p011'">ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p011'</assert>
        <assert id="PEPPOL-T019-R018" flag="warning" test="not(./@*)">
      ...
      <rule context="ubl:TendererQualification/cbc:ContractFolderID">
        <assert id="PEPPOL-T019-R023" flag="warning" test="not(./@*)">
