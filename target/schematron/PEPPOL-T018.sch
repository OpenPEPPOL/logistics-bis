<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <let name="clstatusReason"
           value="tokenize('BV BW SV NF DL RF WT IR MA AE PT', '\s')"/>
      ...
      <rule context="/ubl:ApplicationResponse/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p010:1:2'"
                 flag="fatal"
                 id="PEPPOL-T018-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p010:1:2'.</assert>
      </rule>
      ...
      <rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:LineResponse">
         ...
         <assert test="cac:Response" flag="fatal" id="PEPPOL-T018-B02102">Element 'cac:Response' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:LineResponse/cac:Response/cac:Status/cbc:StatusReasonCode">
         <assert test="(some $code in $clstatusReason satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T018-B02801">Value MUST be part of code list 'StatusReasonCode'.</assert>
      </rule>
      <rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:LineResponse/cac:Response/cac:Status/*">
      ...
      <rule context="/ubl:ApplicationResponse/cac:DocumentResponse/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T018-B01403">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ApplicationResponse/*">
    ...
    <pattern>
      ...
      <rule context="/ubl:ApplicationResponse/cbc:CustomizationID">
        <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t018:1:2'"
                 flag="fatal"
                 id="PEPPOL-T018-R013">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t018:1:2'.</assert>
      </rule>
    
      <rule context="/ubl:ApplicationResponse/cbc:ProfileID">
        <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p010:1:2'"
                 flag="fatal"
                 id="PEPPOL-T018-R014">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p010:1:2'.</assert>
      </rule>
