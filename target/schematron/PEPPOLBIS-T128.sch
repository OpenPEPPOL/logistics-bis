<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:ReceiptAdvice/cbc:RejectReasonCode">
         <assert test="(some $code in $clRejectReasonCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B00901">Value MUST be part of code list 'Reject Reason (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cbc:RejectReason"/>
      <rule context="/ubl:ReceiptAdvice/cbc:RejectActionCode">
         <assert test="(some $code in $clReceiptAdviceActionCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B01101">Value MUST be part of code list 'Receipt Advice Action (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cbc:Note"/>
      <rule context="/ubl:ReceiptAdvice/cac:OrderReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B01301">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:OrderReference/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:OrderReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B01302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B01501">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cbc:IssueDate" flag="fatal" id="PEPPOL-T128-B01502">Element 'cbc:IssueDate' MUST be provided.</assert>
         <assert test="cbc:IssueTime" flag="fatal" id="PEPPOL-T128-B01503">Element 'cbc:IssueTime' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchDocumentReference/cbc:DocumentStatusCode">
         <assert test="(some $code in $clUNCL4343_T128 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B01901">Value MUST be part of code list 'Application Response type code (UNCL4343 Subset T128)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchDocumentReference/cbc:DocumentDescription"/>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchDocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B01504">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B02101">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/cbc:DocumentTypeCode">
         <assert test="(some $code in $clUNCL1001 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B02301">Value MUST be part of code list 'Document name code, full list (UNCL1001)'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T128-B02601">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T128-B02602">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T128-B02603">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T128-B02901">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI"/>
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B02902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/cac:Attachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B02501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:AdditionalDocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B02102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty">
         <assert test="cac:Party" flag="fatal" id="PEPPOL-T128-B03101">Element 'cac:Party' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T128-B03201">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyLegalEntity" flag="fatal" id="PEPPOL-T128-B03202">Element 'cac:PartyLegalEntity' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B03301">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B03302">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B03501">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B03601">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B03801">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T128-B04001">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T128-B04801">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B04901">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B04802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B04002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="fatal" id="PEPPOL-T128-B05001">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="fatal" id="PEPPOL-T128-B05002">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B05201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B05202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyTaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B05003">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity">
         <assert test="cbc:RegistrationName" flag="fatal" id="PEPPOL-T128-B05401">Element 'cbc:RegistrationName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B05601">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B05602">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T128-B05801">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T128-B06001">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B06002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B05802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyLegalEntity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B05402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:Contact/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B06201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B03203">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B03102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty">
         <assert test="cac:Party" flag="fatal" id="PEPPOL-T128-B06601">Element 'cac:Party' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T128-B06701">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyLegalEntity" flag="fatal" id="PEPPOL-T128-B06702">Element 'cac:PartyLegalEntity' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B06801">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B06802">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B07001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B07101">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B07301">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T128-B07501">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T128-B08301">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B08401">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B08302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B07502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="fatal" id="PEPPOL-T128-B08501">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="fatal" id="PEPPOL-T128-B08502">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B08701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B08702">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyTaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B08503">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity">
         <assert test="cbc:RegistrationName" flag="fatal" id="PEPPOL-T128-B08901">Element 'cbc:RegistrationName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B09101">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B09102">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T128-B09301">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T128-B09501">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B09502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B09302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyLegalEntity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B08902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:Contact/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B09701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B06703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B06602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty">
         <assert test="cac:Party" flag="fatal" id="PEPPOL-T128-B10101">Element 'cac:Party' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B10301">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B10401">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B10601">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T128-B10801">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T128-B11601">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B11701">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B11602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B10802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B10201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B10102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty">
         <assert test="cac:Party" flag="fatal" id="PEPPOL-T128-B11801">Element 'cac:Party' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B12001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B12101">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B12301">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T128-B12501">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T128-B13301">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B13401">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B13302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B12502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B11901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B11802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B13801">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:Status" flag="fatal" id="PEPPOL-T128-B13802">Element 'cac:Status' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status">
         <assert test="cbc:ConditionCode" flag="fatal" id="PEPPOL-T128-B14001">Element 'cbc:ConditionCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/cbc:ConditionCode">
         <assert test="(some $code in $clUNCL4343_T128 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B14101">Value MUST be part of code list 'Application Response type code (UNCL4343 Subset T128)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/cbc:StatusReasonCode">
         <assert test="(some $code in $clConsignmentStatusReason satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B14201">Value MUST be part of code list 'Consignment Status Reason (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/cbc:StatusReason"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B14002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B14501">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B14601">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B14801">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:Person">
         <assert test="cac:IdentityDocumentReference"
                 flag="fatal"
                 id="PEPPOL-T128-B15001">Element 'cac:IdentityDocumentReference' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:Person/cac:IdentityDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B15101">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:Person/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B15002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B14401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B13803">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery">
         <assert test="cbc:ActualDeliveryDate" flag="fatal" id="PEPPOL-T128-B15401">Element 'cbc:ActualDeliveryDate' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/cac:DeliveryTerms/cac:DeliveryLocation">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B16001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/cac:DeliveryTerms/cac:DeliveryLocation/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/cac:DeliveryTerms/cac:DeliveryLocation/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B16002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/cac:DeliveryTerms/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B15701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B15402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B16201">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cbc:TransportHandlingUnitTypeCode"
                 flag="fatal"
                 id="PEPPOL-T128-B16202">Element 'cbc:TransportHandlingUnitTypeCode' MUST be provided.</assert>
         <assert test="cac:Status" flag="fatal" id="PEPPOL-T128-B16203">Element 'cac:Status' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cbc:TransportHandlingUnitTypeCode">
         <assert test="(some $code in $clUNECERec21 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B16401">Value MUST be part of code list 'Recommendation 21 (UN/ECE)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:TransportEquipment">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B16501">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:TransportEquipment/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:TransportEquipment/cbc:TransportEquipmentTypeCode">
         <assert test="(some $code in $clUNCL8053 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B16701">Value MUST be part of code list 'Transport equipment type code (UNCL8053) '.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:TransportEquipment/cbc:SizeTypeCode">
         <assert test="(some $code in $clTRED8155 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B16801">Value MUST be part of code list 'Size type code (TRED8155)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:TransportEquipment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B16502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:GoodsItem">
         <assert test="cac:ReceiptLineReference"
                 flag="fatal"
                 id="PEPPOL-T128-B16901">Element 'cac:ReceiptLineReference' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:GoodsItem/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:GoodsItem/cac:ReceiptLineReference">
         <assert test="cbc:LineID" flag="fatal" id="PEPPOL-T128-B17101">Element 'cbc:LineID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:GoodsItem/cac:ReceiptLineReference/cbc:LineID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:GoodsItem/cac:ReceiptLineReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B17102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:GoodsItem/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B16902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Status">
         <assert test="cbc:ConditionCode" flag="fatal" id="PEPPOL-T128-B17301">Element 'cbc:ConditionCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Status/cbc:ConditionCode">
         <assert test="(some $code in $clUNCL4343_T128 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B17401">Value MUST be part of code list 'Application Response type code (UNCL4343 Subset T128)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Status/cbc:StatusReasonCode">
         <assert test="(some $code in $clTransportHandlingUnitReason satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B17501">Value MUST be part of code list 'Transport Handling Unit Reason codes (based on UNCL7007). '.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Status/cbc:StatusReason"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Status/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B17302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package">
         <assert test="cbc:PackagingTypeCode" flag="fatal" id="PEPPOL-T128-B17701">Element 'cbc:PackagingTypeCode' MUST be provided.</assert>
         <assert test="cac:Status" flag="fatal" id="PEPPOL-T128-B17702">Element 'cac:Status' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cbc:PackagingTypeCode">
         <assert test="(some $code in $clUNECERec21 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B17901">Value MUST be part of code list 'Recommendation 21 (UN/ECE)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:GoodsItem">
         <assert test="cac:ReceiptLineReference"
                 flag="fatal"
                 id="PEPPOL-T128-B18001">Element 'cac:ReceiptLineReference' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:GoodsItem/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:GoodsItem/cac:ReceiptLineReference">
         <assert test="cbc:LineID" flag="fatal" id="PEPPOL-T128-B18201">Element 'cbc:LineID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:GoodsItem/cac:ReceiptLineReference/cbc:LineID"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:GoodsItem/cac:ReceiptLineReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B18202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:GoodsItem/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B18002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:Status">
         <assert test="cbc:ConditionCode" flag="fatal" id="PEPPOL-T128-B18401">Element 'cbc:ConditionCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:Status/cbc:ConditionCode">
         <assert test="(some $code in $clUNCL4343_T128 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B18501">Value MUST be part of code list 'Application Response type code (UNCL4343 Subset T128)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:Status/cbc:StatusReasonCode">
         <assert test="(some $code in $clTransportHandlingUnitReason satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B18601">Value MUST be part of code list 'Transport Handling Unit Reason codes (based on UNCL7007). '.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:Status/cbc:StatusReason"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/cac:Status/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B18402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cac:Package/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B17703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B16204">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B13502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B18801">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:DespatchLineReference"
                 flag="fatal"
                 id="PEPPOL-T128-B18802">Element 'cac:DespatchLineReference' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:ReceivedQuantity">
         <assert test="@unitCode" flag="fatal" id="PEPPOL-T128-B19101">Attribute 'unitCode' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:ShortQuantity">
         <assert test="@unitCode" flag="fatal" id="PEPPOL-T128-B19301">Attribute 'unitCode' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:ShortageActionCode">
         <assert test="(some $code in $clReceiptAdviceActionCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B19501">Value MUST be part of code list 'Receipt Advice Action (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:RejectedQuantity">
         <assert test="@unitCode" flag="fatal" id="PEPPOL-T128-B19601">Attribute 'unitCode' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:RejectReasonCode">
         <assert test="(some $code in $clRejectReasonCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B19801">Value MUST be part of code list 'Reject Reason (openPEPPOL)'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:RejectActionCode">
         <assert test="(some $code in $clReceiptAdviceActionCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B20001">Value MUST be part of code list 'Receipt Advice Action (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cbc:OversupplyQuantity">
         <assert test="@unitCode" flag="fatal" id="PEPPOL-T128-B20101">Attribute 'unitCode' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:OrderLineReference">
         <assert test="cbc:LineID" flag="fatal" id="PEPPOL-T128-B20301">Element 'cbc:LineID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:OrderLineReference/cac:OrderReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B20601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:OrderLineReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B20302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:DespatchLineReference">
         <assert test="cbc:LineID" flag="fatal" id="PEPPOL-T128-B20901">Element 'cbc:LineID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:DespatchLineReference/cbc:LineID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:DespatchLineReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B20902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B21101">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cbc:Name"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cbc:ItemTypeCode"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cbc:ItemTypeCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B21301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:BuyersItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B21401">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:BuyersItemIdentification/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:BuyersItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B21402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:SellersItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B21601">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:SellersItemIdentification/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:SellersItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B21602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:ManufacturersItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B21801">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:ManufacturersItemIdentification/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:ManufacturersItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B21802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B22001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B22101">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B22102">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification/cbc:ExtendedID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B22002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B21102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B18803">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/*">
