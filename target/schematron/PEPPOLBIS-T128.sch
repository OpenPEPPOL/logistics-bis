<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <let name="clRejectReasonCode" value="tokenize('1 2 3 4 5 6 99', '\s')"/>
      <let name="clReceiptAdviceTypeCode" value="tokenize('D S', '\s')"/>
      <let name="clConsignmentStatusReason"
           value="tokenize('1 2 3 4 5 6 7 8 99', '\s')"/>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B13301">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clShipmentIDType satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B13302">Value MUST be part of code list 'Type of Shipment ID (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cbc:Information"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B13601">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:Status" flag="fatal" id="PEPPOL-T128-B13602">Element 'cac:Status' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B13701">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clConsignmentIDType satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B13702">Value MUST be part of code list 'Type of Consignment ID (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status">
         <assert test="cbc:ConditionCode" flag="fatal" id="PEPPOL-T128-B13901">Element 'cbc:ConditionCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/cbc:ConditionCode">
         <assert test="(some $code in $clUNCL4343_T128 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B14001">Value MUST be part of code list 'Application Response type code (UNCL4343 Subset T128)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/cbc:StatusReasonCode">
         <assert test="(some $code in $clConsignmentStatusReason satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B14101">Value MUST be part of code list 'Consignment Status Reason (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/cbc:StatusReason"/>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:Status/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B13902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B14401">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B14501">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T128-B14701">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:Person">
         <assert test="cac:IdentityDocumentReference"
                 flag="fatal"
                 id="PEPPOL-T128-B14901">Element 'cac:IdentityDocumentReference' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:Person/cac:IdentityDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B15001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:Person/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B14902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B14301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B13603">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery">
         <assert test="cbc:ActualDeliveryDate" flag="fatal" id="PEPPOL-T128-B15301">Element 'cbc:ActualDeliveryDate' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/cac:DeliveryTerms/cac:DeliveryLocation/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B15902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/cac:DeliveryTerms/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B15601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Delivery/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B15302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B16101">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cbc:TransportHandlingUnitTypeCode"
                 flag="fatal"
                 id="PEPPOL-T128-B16102">Element 'cbc:TransportHandlingUnitTypeCode' MUST be provided.</assert>
         <assert test="cac:Status" flag="fatal" id="PEPPOL-T128-B16103">Element 'cac:Status' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B16201">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clTransportHandlingUnitIDType satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B16202">Value MUST be part of code list 'Type of Transport Handling Unit ID (openPEPPOL)'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B16104">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/*">
      ...
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:BuyersItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B19401">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:BuyersItemIdentification/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:BuyersItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B19402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:SellersItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B19601">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:SellersItemIdentification/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:SellersItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B19602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:ManufacturersItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B19801">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:ManufacturersItemIdentification/cbc:ID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:ManufacturersItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B19802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T128-B20001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B20101">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B20102">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification/cbc:ExtendedID"/>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/cac:StandardItemIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T128-B20002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ReceiptAdvice/cac:ReceiptLine/cac:Item/*">
