<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:EnquiryResponse">
         <assert test="cbc:UBLVersionID" flag="fatal" id="PEPPOL-T010-B00101">Element 'cbc:UBLVersionID' MUST be provided.</assert>
         <assert test="cbc:CustomizationID" flag="fatal" id="PEPPOL-T010-B00102">Element 'cbc:CustomizationID' MUST be provided.</assert>
         <assert test="cbc:ProfileID" flag="fatal" id="PEPPOL-T010-B00103">Element 'cbc:ProfileID' MUST be provided.</assert>
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T010-B00104">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cbc:IssueDate" flag="fatal" id="PEPPOL-T010-B00105">Element 'cbc:IssueDate' MUST be provided.</assert>
         <assert test="cbc:IssueTime" flag="fatal" id="PEPPOL-T010-B00106">Element 'cbc:IssueTime' MUST be provided.</assert>
         <assert test="cac:RequestorParty" flag="fatal" id="PEPPOL-T010-B00107">Element 'cac:RequestorParty' MUST be provided.</assert>
         <assert test="cac:ResponderParty" flag="fatal" id="PEPPOL-T010-B00108">Element 'cac:ResponderParty' MUST be provided.</assert>
         <assert test="cac:ParentDocumentReference"
                 flag="fatal"
                 id="PEPPOL-T010-B00109">Element 'cac:ParentDocumentReference' MUST be provided.</assert>
         <assert test="cac:AdditionalDocumentReference"
                 flag="fatal"
                 id="PEPPOL-T010-B00110">Element 'cac:AdditionalDocumentReference' MUST be provided.</assert>
         <assert test="cac:Attachment" flag="fatal" id="PEPPOL-T010-B00111">Element 'cac:Attachment' MUST be provided.</assert>
         <assert test="not(@*:schemaLocation)" flag="fatal" id="PEPPOL-T010-B00112">Document MUST not contain schema location.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:UBLVersionID">
         <assert test="normalize-space(text()) = '2.2'"
                 flag="fatal"
                 id="PEPPOL-T010-B00201">Element 'cbc:UBLVersionID' MUST contain value '2.2'.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:UBLVersionID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:CustomizationID">
         <assert test="normalize-space(text()) = '&#xA;                urn:fdc:peppol.eu:prac:trns:t010:1.1&#xA;            '"
                 flag="fatal"
                 id="PEPPOL-T010-B00301">Element 'cbc:CustomizationID' MUST contain value '
                urn:fdc:peppol.eu:prac:trns:t010:1.1
            '.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:CustomizationID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p005:1.1'"
                 flag="fatal"
                 id="PEPPOL-T010-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p005:1.1'.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:ProfileID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:ID">
         <assert test="not(@schemeURI) or @schemeURI = 'urn:uuid'"
                 flag="fatal"
                 id="PEPPOL-T010-B00501">Attribute 'schemeURI' MUST contain value 'urn:uuid'</assert>
         <assert test="@schemeURI" flag="fatal" id="PEPPOL-T010-B00502">Attribute 'schemeURI' MUST be present.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00503">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:IssueDate"/>
      <rule context="/ubl:EnquiryResponse/cbc:IssueDate/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:IssueTime"/>
      <rule context="/ubl:EnquiryResponse/cbc:IssueTime/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T010-B00901">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyIdentification" flag="fatal" id="PEPPOL-T010-B00902">Element 'cac:PartyIdentification' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T010-B01001">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T010-B01201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T010-B01301">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T010-B01302">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyIdentification/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01303">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T010-B01501">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyName/cbc:Name"/>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyName/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cac:PartyName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00903">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T010-B01701">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyIdentification" flag="fatal" id="PEPPOL-T010-B01702">Element 'cac:PartyIdentification' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T010-B01801">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T010-B02001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T010-B02101">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T010-B02102">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyIdentification/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02103">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T010-B02301">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyName/cbc:Name"/>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyName/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cac:PartyName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B01703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ParentDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T010-B02501">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ParentDocumentReference/cbc:ID">
         <assert test="not(@schemeName) or @schemeName = 'ContractFolderID'"
                 flag="fatal"
                 id="PEPPOL-T010-B02601">Attribute 'schemeName' MUST contain value 'ContractFolderID'</assert>
         <assert test="@schemeName" flag="fatal" id="PEPPOL-T010-B02602">Attribute 'schemeName' MUST be present.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ParentDocumentReference/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02603">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:ParentDocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:EnquiryResponse/cac:AdditionalDocumentReference/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:AdditionalDocumentReference/cbc:XPath"/>
      <rule context="/ubl:EnquiryResponse/cac:AdditionalDocumentReference/cbc:XPath/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B03101">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:AdditionalDocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B02802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:Attachment">
         <assert test="cac:ExternalReference" flag="fatal" id="PEPPOL-T010-B03201">Element 'cac:ExternalReference' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:EnquiryResponse/cac:Attachment/cac:ExternalReference/cbc:MimeCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B03401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:Attachment/cac:ExternalReference/cbc:FileName"/>
      <rule context="/ubl:EnquiryResponse/cac:Attachment/cac:ExternalReference/cbc:FileName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B03501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:Attachment/cac:ExternalReference/cbc:Description"/>
      <rule context="/ubl:EnquiryResponse/cac:Attachment/cac:ExternalReference/cbc:Description/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B03601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:Attachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B03301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cac:Attachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B03202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T010-B00113">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
   </pattern>
    <pattern>
