<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:EnquiryResponse/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t010:1.2'"
                 flag="fatal"
                 id="PEPPOL-T010-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t010:1.2'.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p005:1.2'"
                 flag="fatal"
                 id="PEPPOL-T010-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p005:1.2'.</assert>
      </rule>
      ...
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T010-B01002">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      ...
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T010-B01802">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:EnquiryResponse/cbc:CustomizationID">
        <assert id="PEPPOL-T010-R009"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t010:1.2'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t010:1.2'</assert>
