<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:EnquiryResponse/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t010:1'"
                 flag="fatal"
                 id="PEPPOL-T010-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t010:1'.</assert>
      </rule>
      <rule context="/ubl:EnquiryResponse/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p005'"
                 flag="fatal"
                 id="PEPPOL-T010-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p005'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:EnquiryResponse/cbc:CustomizationID">
        <assert id="PEPPOL-T010-R009"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t010:1'">CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t010:1'</assert>
