<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <let name="clublDocumentSchema" value="tokenize('CN CAN PIN', '\s')"/>
      ...
      <rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:DocumentTypeCode">
         <assert test="(some $code in $clublDocumentSchema satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T016-B02501">Value MUST be part of code list 'ublDocumentSchema'.</assert>
      </rule>
