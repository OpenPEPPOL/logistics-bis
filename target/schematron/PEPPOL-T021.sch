<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:UnsubscribeFromProcedureRequest/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t021:1:3'"
                 flag="fatal"
                 id="PEPPOL-T021-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t021:1:3'.</assert>
      </rule>
      <rule context="/ubl:UnsubscribeFromProcedureRequest/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p001:1:3'"
                 flag="fatal"
                 id="PEPPOL-T021-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p001:1:3'.</assert>
      </rule>
      ...
      <rule context="/ubl:UnsubscribeFromProcedureRequest/cac:ProcurementProjectLotReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T021-B04701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:UnsubscribeFromProcedureRequest/cbc:CustomizationID">
        <assert id="PEPPOL-T021-R002"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t021:1:3'">[PEPPOL-T021-R002] CustomizationID value MUST be
            'urn:fdc:peppol.eu:prac:trns:t021:1:3'</assert>
      ...
      <rule context="ubl:UnsubscribeFromProcedureRequest/cbc:ProfileID">
        <assert id="PEPPOL-T021-R004"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p001:1:3'">[PEPPOL-T021-R004] ProfileID value MUST be
