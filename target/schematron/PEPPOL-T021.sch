    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:UnsubscribeFromProcedureRequest/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p001'"
                 flag="fatal"
                 id="PEPPOL-T021-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p001'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:UnsubscribeFromProcedureRequest/cbc:ProfileID">
        <assert id="PEPPOL-T021-R004"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p001'">[PEPPOL-T021-R004] ProfileID value MUST be
