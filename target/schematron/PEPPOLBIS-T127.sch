<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:TransportationStatus/cbc:ProfileExecutionID"/>
      ...
      <rule context="/ubl:TransportationStatus/cbc:TransportationStatusTypeCode">
         <assert test="(some $code in $clTransportationStatusTypeCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B01001">Value MUST be part of code list 'Transportation Status Type Code (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cbc:TransportExecutionStatusCode">
         <assert test="(some $code in $clTransportationStatusCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B01201">Value MUST be part of code list 'Transportation Status Code (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B01301">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:Status" flag="fatal" id="PEPPOL-T127-B01302">Element 'cac:Status' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clConsignmentIDType satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B01401">Value MUST be part of code list 'Type of Consignment ID (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:Status">
         <assert test="cbc:Description" flag="fatal" id="PEPPOL-T127-B01601">Element 'cbc:Description' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:Status/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B01701">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:Status/cbc:Description"/>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:Status/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B01602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cbc:TransportEventTypeCode">
         <assert test="(some $code in $clTransportEventTypeCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B02401">Value MUST be part of code list 'Transport Event Type Code (openPEPPOL)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:CurrentStatus">
         <assert test="cbc:Description" flag="fatal" id="PEPPOL-T127-B02601">Element 'cbc:Description' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:CurrentStatus/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B02701">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:CurrentStatus/cbc:StatusReasonCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B03001">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:CurrentStatus/cbc:StatusReason"/>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:CurrentStatus/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B02602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B03301">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:SignatoryParty" flag="fatal" id="PEPPOL-T127-B03302">Element 'cac:SignatoryParty' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty">
         <assert test="cac:Person" flag="fatal" id="PEPPOL-T127-B03701">Element 'cac:Person' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B03801">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B04001">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B04601">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B04801">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B04901">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B04802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B04002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:Person">
         <assert test="cbc:FamilyName" flag="fatal" id="PEPPOL-T127-B05001">Element 'cbc:FamilyName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:Person/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B05002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:SignatoryParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B03702">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B05701">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B05702">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B05703">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B06001">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B06002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B05601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Signature/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B03303">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Period/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B06201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B02001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B06701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clTransportHandlingUnitIDType satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B06801">Value MUST be part of code list 'Type of Transport Handling Unit ID (openPEPPOL)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status">
         <assert test="cbc:Description" flag="fatal" id="PEPPOL-T127-B07001">Element 'cbc:Description' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B07101">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status/cbc:Description"/>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B07002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B06702">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B01303">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent">
         <assert test="cbc:IdentificationID" flag="fatal" id="PEPPOL-T127-B07401">Element 'cbc:IdentificationID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cbc:TransportEventTypeCode">
         <assert test="(some $code in $clTransportEventTypeCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B07801">Value MUST be part of code list 'Transport Event Type Code (openPEPPOL)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus">
         <assert test="cbc:Description" flag="fatal" id="PEPPOL-T127-B08001">Element 'cbc:Description' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B08101">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus/cbc:StatusReasonCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B08401">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus/cbc:StatusReason"/>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B08002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B08701">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:SignatoryParty" flag="fatal" id="PEPPOL-T127-B08702">Element 'cac:SignatoryParty' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty">
         <assert test="cac:Person" flag="fatal" id="PEPPOL-T127-B09101">Element 'cac:Person' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B09201">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B09401">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B10001">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B10201">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B10301">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B10202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B09402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:Person">
         <assert test="cbc:FamilyName" flag="fatal" id="PEPPOL-T127-B10401">Element 'cbc:FamilyName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:Person/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B10402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B09102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B11101">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B11102">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B11103">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B11401">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B11402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B11001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B08703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Period/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B11601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B07402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B12101">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cbc:DocumentTypeCode">
         <assert test="(some $code in $clUNCL1001 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B12301">Value MUST be part of code list 'Document name code, full list (UNCL1001)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B12601">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B12602">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B12603">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B12901">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI"/>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B13101">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:SignatoryParty" flag="fatal" id="PEPPOL-T127-B13102">Element 'cac:SignatoryParty' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty">
         <assert test="cac:Person" flag="fatal" id="PEPPOL-T127-B13501">Element 'cac:Person' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B13601">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B13801">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B14401">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B14601">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B14701">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B14602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:Person">
         <assert test="cbc:FamilyName" flag="fatal" id="PEPPOL-T127-B14801">Element 'cbc:FamilyName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:Person/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B14802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B13502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B15501">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B15502">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B15503">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B15801">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/cbc:URI"/>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B15802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B15401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B13103">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T127-B16001">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyLegalEntity" flag="fatal" id="PEPPOL-T127-B16002">Element 'cac:PartyLegalEntity' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B16101">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B16102">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B16301">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B16401">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B16601">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B16801">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B17401">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B17601">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B17701">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B17602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B16802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="fatal" id="PEPPOL-T127-B17801">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="fatal" id="PEPPOL-T127-B17802">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme/cac:TaxScheme">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B18001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID"/>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme/cac:TaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B18002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B17803">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity">
         <assert test="cbc:RegistrationName" flag="fatal" id="PEPPOL-T127-B18201">Element 'cbc:RegistrationName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B18401">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B18402">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B18601">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B18801">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B18901">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B18802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B18602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B18202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:Contact/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B19001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B16003">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T127-B19401">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyLegalEntity" flag="fatal" id="PEPPOL-T127-B19402">Element 'cac:PartyLegalEntity' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B19501">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B19502">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B19701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B19801">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B20001">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B20201">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B20801">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B21001">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B21101">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B21002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B20202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="fatal" id="PEPPOL-T127-B21201">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="fatal" id="PEPPOL-T127-B21202">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/cac:TaxScheme">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B21401">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID"/>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/cac:TaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B21402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B21203">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity">
         <assert test="cbc:RegistrationName" flag="fatal" id="PEPPOL-T127-B21601">Element 'cbc:RegistrationName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B21801">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B21802">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B22001">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B22201">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B22301">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B22202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B22002">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B21602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:Contact/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B22401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B19403">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportationStatusRequestDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B22801">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportationStatusRequestDocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B22802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportExecutionPlanDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B23201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportExecutionPlanDocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B23202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/*">
