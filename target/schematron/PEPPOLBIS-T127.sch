<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:CurrentStatus/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B02501">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B06801">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent">
         <assert test="cbc:IdentificationID" flag="fatal" id="PEPPOL-T127-B07101">Element 'cbc:IdentificationID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cbc:TransportEventTypeCode">
         <assert test="(some $code in $clTransportEventTypeCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B07501">Value MUST be part of code list 'Transport Event Type Code (openPEPPOL)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus">
         <assert test="cbc:Description" flag="fatal" id="PEPPOL-T127-B07701">Element 'cbc:Description' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus/cbc:ConditionCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T127-B07801">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:CurrentStatus/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B07702">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B08401">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:SignatoryParty" flag="fatal" id="PEPPOL-T127-B08402">Element 'cac:SignatoryParty' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty">
         <assert test="cac:Person" flag="fatal" id="PEPPOL-T127-B08801">Element 'cac:Person' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B08901">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B09101">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B09701">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B09901">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B10001">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:SignatoryParty/cac:Person">
         <assert test="cbc:FamilyName" flag="fatal" id="PEPPOL-T127-B10101">Element 'cbc:FamilyName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B10801">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B10802">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B10803">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B11101">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/cac:DigitalSignatureAttachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B10701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Signature/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B08403">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cac:Period/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B11301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cbc:DocumentTypeCode">
         <assert test="(some $code in $clUNCL1001 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B12001">Value MUST be part of code list 'Document name code, full list (UNCL1001)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B12301">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B12302">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B12303">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B12601">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI"/>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B12801">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:SignatoryParty" flag="fatal" id="PEPPOL-T127-B12802">Element 'cac:SignatoryParty' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty">
         <assert test="cac:Person" flag="fatal" id="PEPPOL-T127-B13201">Element 'cac:Person' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B13301">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B13501">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B14101">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:Person">
         <assert test="cbc:FamilyName" flag="fatal" id="PEPPOL-T127-B14501">Element 'cbc:FamilyName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B15201">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B15202">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B15203">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B15501">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/cbc:URI"/>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B15502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:DigitalSignatureAttachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B15101">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12803">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
