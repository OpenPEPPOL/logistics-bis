<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent">
         <assert test="cac:Period" flag="fatal" id="PEPPOL-T127-B01801">Element 'cac:Period' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/cac:Period/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B03101">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportEvent/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B01802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B03601">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status">
         <assert test="cbc:Description" flag="fatal" id="PEPPOL-T127-B03801">Element 'cbc:Description' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Consignment/cac:TransportHandlingUnit/cac:Status/cbc:ConditionCode">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B03901">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B04201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cbc:DocumentTypeCode">
         <assert test="(some $code in $clUNCL1001 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B04401">Value MUST be part of code list 'Document name code, full list (UNCL1001)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject">
         <assert test="@mimeCode" flag="fatal" id="PEPPOL-T127-B04701">Attribute 'mimeCode' MUST be present.</assert>
         <assert test="not(@mimeCode) or (some $code in $clMimeCode satisfies $code = @mimeCode)"
                 flag="fatal"
                 id="PEPPOL-T127-B04702">Value MUST be part of code list 'Mime code (IANA Subset)'.</assert>
         <assert test="@filename" flag="fatal" id="PEPPOL-T127-B04703">Attribute 'filename' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="fatal" id="PEPPOL-T127-B05001">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/cac:Attachment/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B04601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:DocumentReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B04202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B05201">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:SignatoryParty" flag="fatal" id="PEPPOL-T127-B05202">Element 'cac:SignatoryParty' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty">
         <assert test="cac:Person" flag="fatal" id="PEPPOL-T127-B05601">Element 'cac:Person' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B05701">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B05901">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B06501">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B06701">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B06801">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:PostalAddress/cac:Country/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/cac:Person">
         <assert test="cbc:FamilyName" flag="fatal" id="PEPPOL-T127-B06901">Element 'cbc:FamilyName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/cac:SignatoryParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B05602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:Signature/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B05203">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportEvent">
         <assert test="cbc:IdentificationID" flag="fatal" id="PEPPOL-T127-B08101">Element 'cbc:IdentificationID' MUST be provided.</assert>
         <assert test="cbc:OccurrenceDate" flag="fatal" id="PEPPOL-T127-B08102">Element 'cbc:OccurrenceDate' MUST be provided.</assert>
         <assert test="cbc:OccurrenceTime" flag="fatal" id="PEPPOL-T127-B08103">Element 'cbc:OccurrenceTime' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/cbc:TransportEventTypeCode">
         <assert test="(some $code in $clTransportEventTypeCode satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B08501">Value MUST be part of code list 'Transport Event Type Code (openPEPPOL)'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportEvent/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B08104">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T127-B11501">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyLegalEntity" flag="fatal" id="PEPPOL-T127-B11502">Element 'cac:PartyLegalEntity' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B11601">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B11602">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B11801">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B11901">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B12101">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B12301">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B12901">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B13101">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B13201">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B13102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PostalAddress/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B12302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="fatal" id="PEPPOL-T127-B13301">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="fatal" id="PEPPOL-T127-B13302">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme/cac:TaxScheme">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B13501">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyTaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B13303">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity">
         <assert test="cbc:RegistrationName" flag="fatal" id="PEPPOL-T127-B13701">Element 'cbc:RegistrationName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B13901">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B13902">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B14101">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B14301">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B14401">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B14302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:PartyLegalEntity/cac:RegistrationAddress/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:SenderParty/cac:Contact/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B14501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:SenderParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B11503">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T127-B14901">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyLegalEntity" flag="fatal" id="PEPPOL-T127-B14902">Element 'cac:PartyLegalEntity' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cbc:EndpointID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B15001">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B15002">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyIdentification">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B15201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyIdentification/cbc:ID">
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B15301">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyName">
         <assert test="cbc:Name" flag="fatal" id="PEPPOL-T127-B15501">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B15701">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:AddressLine">
         <assert test="cbc:Line" flag="fatal" id="PEPPOL-T127-B16301">Element 'cbc:Line' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B16501">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B16601">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PostalAddress/cac:Country/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="fatal" id="PEPPOL-T127-B16701">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="fatal" id="PEPPOL-T127-B16702">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/cac:TaxScheme">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B16901">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID"/>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/cac:TaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B16902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyTaxScheme/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B16703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity">
         <assert test="cbc:RegistrationName" flag="fatal" id="PEPPOL-T127-B17101">Element 'cbc:RegistrationName' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T127-B17301">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T127-B17302">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress">
         <assert test="cac:Country" flag="fatal" id="PEPPOL-T127-B17501">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="fatal" id="PEPPOL-T127-B17701">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T127-B17801">Value MUST be part of code list 'Country codes (ISO 3166-1:Alpha2)'.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:PartyLegalEntity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B17102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/cac:Contact/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B17901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:ReceiverParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T127-B14903">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:TransportationStatus/cac:TransportationStatusRequestDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B18301">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatus/cac:TransportExecutionPlanDocumentReference">
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T127-B18701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
