<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:Tender/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t005:1.3'"
                 flag="fatal"
                 id="PEPPOL-T005-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t005:1.3'.</assert>
      </rule>
      <rule context="/ubl:Tender/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p003:1.3'"
                 flag="fatal"
                 id="PEPPOL-T005-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p003:1.3'.</assert>
      </rule>
      ...
      <rule context="/ubl:Tender/cac:TendererParty/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T005-B02602">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      ...
      <rule context="/ubl:Tender/cac:TendererParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T005-B04001">Value MUST be part of code list 'ISO 3166-1:Alpha2 Country codes'.</assert>
         <assert test="@listID" flag="fatal" id="PEPPOL-T005-B04002">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Tender/cac:TendererParty/cac:PostalAddress/cac:Country/*">
      ...
      <rule context="/ubl:Tender/cac:TendererParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="(some $code in $clISO3166 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T005-B04601">Value MUST be part of code list 'ISO 3166-1:Alpha2 Country codes'.</assert>
         <assert test="@listID" flag="fatal" id="PEPPOL-T005-B04602">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Tender/cac:TendererParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
      ...
      <rule context="/ubl:Tender/cac:ContractingParty/cac:Party/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T005-B05502">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:Tender/cbc:CustomizationID">
        <assert id="PEPPOL-T005-R010"
                 flag="fatal"
                 test="normalize-space(.) = ('urn:fdc:peppol.eu:prac:trns:t005:1.3','urn:fdc:peppol.eu:prac:trns:t005:1.3')">[PEPPOL-T005-R010] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t005:1.3' or 'urn:fdc:peppol.eu:prac:trns:t005:1.3'</assert>
      ...
      <rule context="ubl:Tender/cbc:ProfileID">
        <assert id="PEPPOL-T005-R011"
                 flag="fatal"
                 test="normalize-space(.) = ('urn:fdc:peppol.eu:prac:bis:p003:1.3','urn:fdc:peppol.eu:prac:bis:p003:1.3')">[PEPPOL-T005-R011] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p003:1.3' or 'urn:fdc:peppol.eu:prac:bis:p003:1.3'</assert>
      ...
      <rule context="ubl:Tender/cac:DocumentReference/cac:Attachment">
        ...
        <assert id="PEPPOL-T005-R024"
                 flag="fatal"
                 test="exists(cac:ExternalReference/cbc:HashAlgorithmMethod)">[PEPPOL-T005-R024] An Attachment MUST have a hash algorithm method</assert>
        <assert id="PEPPOL-T005-R025"
                 flag="fatal"
                 test="normalize-space(cac:ExternalReference/cbc:HashAlgorithmMethod) = 'http://www.w3.org/2001/04/xmlenc#sha256'">[PEPPOL-T005-R025] Hash Algorithm MUST be SHA-256 (http://www.w3.org/2001/04/xmlenc#sha256)</assert>
      </rule>
