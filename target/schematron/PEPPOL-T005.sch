<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:Tender/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t005:1'"
                 flag="fatal"
                 id="PEPPOL-T005-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t005:1'.</assert>
      </rule>
      <rule context="/ubl:Tender/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p003'"
                 flag="fatal"
                 id="PEPPOL-T005-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p003'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:Tender/cbc:CustomizationID">
        <assert id="PEPPOL-T005-R010"
                 flag="fatal"
                 test="normalize-space(.) = ('urn:fdc:peppol.eu:prac:trns:t005:1','urn:fdc:peppol.eu:prac:trns:t005:1.3')">[PEPPOL-T005-R010] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t005:1' or 'urn:fdc:peppol.eu:prac:trns:t005:1.3'</assert>
      ...
      <rule context="ubl:Tender/cbc:ProfileID">
        <assert id="PEPPOL-T005-R011"
                 flag="fatal"
                 test="normalize-space(.) = ('urn:fdc:peppol.eu:prac:bis:p003','urn:fdc:peppol.eu:prac:bis:p003:1.3')">[PEPPOL-T005-R011] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p003' or 'urn:fdc:peppol.eu:prac:bis:p003:1.3'</assert>
