<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:UBLVersionID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:CustomizationID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:ProfileID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00503">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:ContractFolderID"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:ContractFolderID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:IssueDate"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:IssueDate/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:IssueTime"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:IssueTime/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B00901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cbc:PreferredLanguageLocaleCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B01003">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B01402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cbc:IndustryClassificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B01603">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyIdentification/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B01903">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B01802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyName/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:StreetName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:CityName"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:CityName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:PostalZone"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:PostalZone/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B02801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="not(@listID) or @listID = 'ISO3166-1:Alpha2'"
                 flag="fatal"
                 id="PEPPOL-T001-B03001">Attribute 'listID' MUST contain value 'ISO3166-1:Alpha2'</assert>
         <assert test="@listID" flag="fatal" id="PEPPOL-T001-B03002">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B03003">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PostalAddress/cac:Country/*">
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="not(@listID) or @listID = 'ISO3166-1:Alpha2'"
                 flag="fatal"
                 id="PEPPOL-T001-B03501">Attribute 'listID' MUST contain value 'ISO3166-1:Alpha2'</assert>
         <assert test="@listID" flag="fatal" id="PEPPOL-T001-B03502">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B03503">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B03801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:Telephone"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:Telephone/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B03901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:Telefax"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:Telefax/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B04001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:ElectronicMail"/>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/cbc:ElectronicMail/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B04101">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:EconomicOperatorParty/cac:Party/cac:Contact/*">
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:ContractingParty/cac:Party/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B04402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:ContractingParty/cac:Party/cac:PartyIdentification/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B04703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:ContractingParty/cac:Party/cac:PartyIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B04602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:ContractingParty/cac:Party/*">
      ...
      <rule context="/ubl:ExpressionOfInterestRequest/cac:ProcurementProjectLotReference/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B05001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/cac:ProcurementProjectLotReference/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T001-B04901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestRequest/*">
