<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <ns prefix="ubl"
       uri="urn:oasis:names:specification:ubl:schema:xsd:ExpressionOfInterestResponse-2"/>
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:ExpressionOfInterestResponse">
         <assert test="cbc:UBLVersionID" flag="fatal" id="PEPPOL-T002-B00101">Element 'cbc:UBLVersionID' MUST be provided.</assert>
         <assert test="cbc:CustomizationID" flag="fatal" id="PEPPOL-T002-B00102">Element 'cbc:CustomizationID' MUST be provided.</assert>
         <assert test="cbc:ProfileID" flag="fatal" id="PEPPOL-T002-B00103">Element 'cbc:ProfileID' MUST be provided.</assert>
         <assert test="cbc:ID" flag="fatal" id="PEPPOL-T002-B00104">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cbc:ContractFolderID" flag="fatal" id="PEPPOL-T002-B00105">Element 'cbc:ContractFolderID' MUST be provided.</assert>
         <assert test="cbc:IssueDate" flag="fatal" id="PEPPOL-T002-B00106">Element 'cbc:IssueDate' MUST be provided.</assert>
         <assert test="cbc:IssueTime" flag="fatal" id="PEPPOL-T002-B00107">Element 'cbc:IssueTime' MUST be provided.</assert>
         <assert test="cac:EconomicOperatorParty"
                 flag="fatal"
                 id="PEPPOL-T002-B00108">Element 'cac:EconomicOperatorParty' MUST be provided.</assert>
         <assert test="cac:ContractingParty" flag="fatal" id="PEPPOL-T002-B00109">Element 'cac:ContractingParty' MUST be provided.</assert>
         <assert test="not(@*:schemaLocation)" flag="fatal" id="PEPPOL-T002-B00110">Document MUST not contain schema location.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestResponse/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t002:1:3'"
                 flag="fatal"
                 id="PEPPOL-T002-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t002:1:3'.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestResponse/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p001:1:3'"
                 flag="fatal"
                 id="PEPPOL-T002-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p001:1:3'.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty">
         <assert test="cac:Party" flag="fatal" id="PEPPOL-T002-B01501">Element 'cac:Party' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty/cac:Party">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T002-B01601">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyIdentification" flag="fatal" id="PEPPOL-T002-B01602">Element 'cac:PartyIdentification' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty/cac:Party/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T002-B01702">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T002-B02001">Attribute 'schemeID' MUST be present.</assert>
      ...
      <rule context="/ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T002-B01502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestResponse/cac:ContractingParty">
         <assert test="cac:Party" flag="fatal" id="PEPPOL-T002-B02201">Element 'cac:Party' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestResponse/cac:ContractingParty/cac:Party">
         <assert test="cbc:EndpointID" flag="fatal" id="PEPPOL-T002-B02301">Element 'cbc:EndpointID' MUST be provided.</assert>
         <assert test="cac:PartyIdentification" flag="fatal" id="PEPPOL-T002-B02302">Element 'cac:PartyIdentification' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:ExpressionOfInterestResponse/cac:ContractingParty/cac:Party/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T002-B02402">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      ...
      <rule context="/ubl:ExpressionOfInterestResponse/cac:ContractingParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T002-B02701">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
      ...
      <rule context="/ubl:ExpressionOfInterestResponse/cac:ContractingParty/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T002-B02202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
    ...
    <pattern>
        ...
        <rule context="ubl:ExpressionOfInterestResponse">
            ...
            <assert id="PEPPOL-T002-R023"
                 flag="fatal"
                 test="count(distinct-values(cac:ProcurementProjectLotReference/cbc:ID)) = count(cac:ProcurementProjectLotReference/cbc:ID)">[PEPPOL-T002-R023] Lot identifiers MUST be unique.</assert>
            ...
            <report id="PEPPOL-T002-S301" flag="warning" test="(ext:UBLExtensions)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S301] UBLExtensions SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S305"
                 flag="warning"
                 test="(cbc:ProfileExectuionID)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S305] ProfileExecutionID SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S307" flag="warning" test="(cbc:CopyIndicator)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S307] CopyIndicator SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S308" flag="warning" test="(cbc:UUID)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S308] UUID SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S310" flag="warning" test="(cbc:ContractName)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S310] ContractName SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S312" flag="warning" test="(cbc:Note)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S312] Note SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S313"
                 flag="warning"
                 test="count(cac:ExpressionOfInterestDocumentReference) &gt; 1">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S313] Expression of Interest Document Reference SHOULD NOT be used more than once.</report>
            <report id="PEPPOL-T002-S320" flag="warning" test="(cac:Signature)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S320] Signature SHOULD NOT be used.</report>
            <report id="PEPPOL-T002-S331"
                 flag="warning"
                 test="count(cac:ContractingParty) &gt; 1">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S331] ContractingParty SHOULD NOT be used more than once.</report>
            <report id="PEPPOL-T002-S329"
                 flag="warning"
                 test="(cac:ProcurementProject)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S329] ProcurementProject SHOULD NOT be used.</report>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cbc:UBLVersionID">
            <assert id="PEPPOL-T002-R029"
                 flag="fatal"
                 test="normalize-space(.) = '2.2'">[PEPPOL-T002-R029] UBLVersionID value MUST be '2.2'</assert>
            <report id="PEPPOL-T002-S302" flag="warning" test="./@*">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S302] UBLVersionID SHOULD NOT contain any attributes.</report>
        </rule>
                
        <rule context="ubl:ExpressionOfInterestResponse/cbc:CustomizationID">
            <assert id="PEPPOL-T002-R002"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t002:1:3'">[PEPPOL-T002-R002] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t002:1:3'</assert>
            <report id="PEPPOL-T002-S303" flag="warning" test="./@*">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S303] CustomizationID SHOULD NOT have any attributes.</report>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cbc:ProfileID">
            <assert id="PEPPOL-T002-R004"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p001:1:3'">[PEPPOL-T002-R004] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p001:1:3'</assert>
            <report id="PEPPOL-T002-S304" flag="warning" test="./@*">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S304] ProfileID SHOULD NOT have any attributes.</report>
        </rule>
        ...
        <rule context="ubl:ExpressionOfInterestResponse/cbc:ID">
            ...
            <assert id="PEPPOL-T002-R007"
                 flag="fatal"
                 test="normalize-space(./@schemeURI)='urn:uuid'">[PEPPOL-T002-R007] schemeURI for Expression of Interest Confirmation Identifier MUST be 'urn:uuid'.</assert>
            <report id="PEPPOL-T002-S306"
                 flag="warning"
                 test="./@*[not(name()='schemeURI')]">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S306] ID SHOULD NOT have any further attributes but schemeURI</report>
            <assert id="PEPPOL-T002-R008"
                 flag="fatal"
                 test="matches(normalize-space(.),'^[a-fA-F0-9]{8}(\-[a-fA-F0-9]{4}){3}\-[a-fA-F0-9]{12}$')">[PEPPOL-T002-R008] Expression of Interest Confirmation Identifier value MUST be expressed in a UUID syntax (RFC 4122)</assert>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cbc:ContractFolderID">
            <report id="PEPPOL-T002-S309" flag="warning" test="./@*">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S309] ContractFolderID SHOULD NOT have any attributes.</report>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cbc:IssueTime">
            <assert id="PEPPOL-T002-R012"
                 flag="fatal"
                 test="count(timezone-from-time(.)) &gt; 0">[PEPPOL-T002-R012] IssueTime MUST include timezone information.</assert>
            <assert id="PEPPOL-T002-R013"
                 flag="fatal"
                 test="matches(normalize-space(.),'^(([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]|(24:00:00))(Z|(\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?$')">[PEPPOL-T002-R013] IssueTime MUST have a granularity of seconds</assert>
        </rule>
        ...
        <rule context="ubl:ExpressionOfInterestResponse/cbc:TenderLanguageLocaleCode">
            ...
            <value-of select="$syntaxError"/>[PEPPOL-T002-S311] TenderLanguageLocaleCode SHOULD NOT have any further attributes but listID</report>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cac:ExpressionOfInterestDocumentReference">
            <assert id="PEPPOL-T002-S314"
                 flag="warning"
                 test="count(./*)-count(./cbc:ID)=0">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S314] Expression of Interest Document Reference SHOULD NOT contain any other elements but ID.</assert>
        </rule>
        ...
        <rule context="ubl:ExpressionOfInterestResponse/cac:ExpressionOfInterestDocumentReference/cbc:ID">
            ...
            <assert id="PEPPOL-T002-R026"
                 flag="fatal"
                 test="normalize-space(./@schemeURI)='urn:uuid'">[PEPPOL-T002-R026] schemeURI for Expression of Interest Document Reference Identifier SHOULD be 'urn:uuid'.</assert>
            <assert id="PEPPOL-T002-R027"
                 flag="fatal"
                 test="matches(normalize-space(.),'^[a-fA-F0-9]{8}(\-[a-fA-F0-9]{4}){3}\-[a-fA-F0-9]{12}$')">[PEPPOL-T002-R027] Expression of Interest Document Reference Identifier value MUST be expressed in a UUID syntax (RFC 4122)</assert>
            <report id="PEPPOL-T002-S318"
                 flag="warning"
                 test="./@*[not(name()='schemeURI')]">
        ...
        <rule context="ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty">
            <report id="PEPPOL-T002-S321"
                 flag="warning"
                 test="(cac:EconomicOperatorRole)">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S321] EconomicOperatorRole SHOULD NOT be used.</report>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cac:EconomicOperatorParty/cac:Party">
            <assert id="PEPPOL-T002-S322"
                 flag="warning"
                 test="count(./*)-count(./cbc:EndpointID)-count(./cac:PartyIdentification)= 0">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S322] An EconomicOperatorParty/cac:Party element SHOULD NOT contain any other elements but EndpointID, PartyIdentification</assert>
            <assert id="PEPPOL-T002-R015"
                 flag="fatal"
                 test="(./cac:PartyIdentification) and (./cbc:EndpointID)">[PEPPOL-T002-R015] An Expression of Interest Confirmation MUST identify the Economic Operator by its party identifier and its endpoint identifier.</assert>
        </rule>

        <rule context="ubl:ExpressionOfInterestResponse/cac:ContractingParty">
            <assert id="PEPPOL-T002-S323"
                 flag="warning"
                 test="count(./*)-count(./cac:Party)=0">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S323] ContractingParty MUST NOT contain any other elements but cac:Party.</assert>
        </rule>
        
        <rule context="ubl:ExpressionOfInterestResponse/cac:ContractingParty/cac:Party">
            <assert id="PEPPOL-T002-S324"
                 flag="warning"
                 test="count(./*)-count(./cac:PartyIdentification)-count(./cbc:EndpointID)-count(./cac:PartyName)= 0">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S324] A ContractingParty/cac:Party element SHOULD NOT contain any other elements but EndpointID, PartyIdentification, PartyName</assert>
            <assert id="PEPPOL-T002-R014"
                 flag="fatal"
                 test="(./cac:PartyIdentification) and (./cbc:EndpointID)">[PEPPOL-T002-R014] An Expression of Interest Confirmation MUST identify the Contracting Body by its party identifier and its endpoint identifier.</assert>
        </rule>    

        <rule context="cac:Party">
            <report id="PEPPOL-T002-S325"
                 flag="warning"
                 test="count(./cac:PartyIdentification) &gt; 1">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S325] PartyIdentification SHOULD NOT be used more than once</report>
            <report id="PEPPOL-T002-S326"
                 flag="warning"
                 test="count(./cac:PartyName) &gt; 1">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S326] PartyName SHOULD NOT be used more than once</report>
        </rule>
        ...
        <rule context="cac:Party/cbc:EndpointID">
            ...
            <value-of select="$syntaxError"/>[PEPPOL-T002-S328] EndpointID SHOULD NOT have any further attributes but schemeID</report>
        </rule>
        ...
        <rule context="cac:PartyIdentification/cbc:ID">
            ...
            <report id="PEPPOL-T002-S332"
                 flag="warning"
                 test="./@*[not(name()='schemeID')]">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S332] cac:PartyIdentification/cbc:ID SHOULD NOT have any further attributes but schemeID</report>
        </rule>
        
        <rule context="cbc:Name">
            <report id="PEPPOL-T002-S327" flag="warning" test="./@*">
            <value-of select="$syntaxError"/>[PEPPOL-T002-S327] cbc:Name SHOULD NOT have any further attributes</report>
        </rule>
