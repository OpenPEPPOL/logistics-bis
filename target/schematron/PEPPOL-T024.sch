<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:CallForTenders/cbc:UBLVersionID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cbc:CustomizationID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cbc:ProfileID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00503">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cbc:ContractFolderID"/>
      <rule context="/ubl:CallForTenders/cbc:ContractFolderID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cbc:IssueDate"/>
      <rule context="/ubl:CallForTenders/cbc:IssueDate/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cbc:IssueTime"/>
      <rule context="/ubl:CallForTenders/cbc:IssueTime/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B00901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cbc:VersionID"/>
      <rule context="/ubl:CallForTenders/cbc:VersionID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:IssueDate"/>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:IssueDate/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:DocumentTypeCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01404">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:LocaleCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01603">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:VersionID"/>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:VersionID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:DocumentStatusCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B01904">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:DocumentDescription"/>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cbc:DocumentDescription/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B02101">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B02401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:MimeCode"/>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:MimeCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B02501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:FileName"/>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:FileName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B02601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B02902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyIdentification/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B03203">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B03102">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyName/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B03501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B03402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="not(@listID) or @listID = 'ISO3166-1:Alpha2'"
                 flag="fatal"
                 id="PEPPOL-T024-B03901">Attribute 'listID' MUST contain value 'ISO3166-1:Alpha2'</assert>
         <assert test="@listID" flag="fatal" id="PEPPOL-T024-B03902">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B03903">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ContractingParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B04202">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cbc:IndustryClassificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B04404">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyIdentification/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B04703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyIdentification/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B04602">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyName/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B04902">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:StreetName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:AdditionalStreetName"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:AdditionalStreetName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:CityName"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:CityName/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:PostalZone"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:PostalZone/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:CountrySubentity"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cbc:CountrySubentity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T024-B05801">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B05802">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PostalAddress/cac:Country/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyLegalEntity/cbc:CompanyLegalForm/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B06101">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode">
         <assert test="@listID" flag="fatal" id="PEPPOL-T024-B06401">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B06402">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B06701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:Telephone"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:Telephone/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B06801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:Telefax"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:Telefax/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B06901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:ElectronicMail"/>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/cbc:ElectronicMail/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ReceiverParty/cac:Contact/*">
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cbc:MaximumVariantQuantity/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07201">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cbc:VariantConstraintIndicator"/>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cbc:VariantConstraintIndicator/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cbc:Note"/>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cbc:Note/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cbc:AdditionalConditions/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07502">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:ProcurementLegislationDocumentReference/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:ProcurementLegislationDocumentReference/cbc:DocumentDescription"/>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:ProcurementLegislationDocumentReference/cbc:DocumentDescription/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B07801">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:ProcurementLegislationDocumentReference/*">
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:CallForTendersDocumentReference/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B08003">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:CallForTendersDocumentReference/*">
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:TenderRecipientParty/cbc:EndpointID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B08302">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingTerms/cac:TenderRecipientParty/*">
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cbc:ProcedureCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B08604">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cbc:ContractingSystemCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B08804">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cbc:SubmissionMethodCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B09004">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:TenderSubmissionDeadlinePeriod/cbc:EndDate/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B09301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:TenderSubmissionDeadlinePeriod/cbc:EndTime"/>
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:TenderSubmissionDeadlinePeriod/cbc:EndTime/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B09401">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:TenderSubmissionDeadlinePeriod/*">
      ...
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:ParticipationRequestReceptionPeriod/cbc:EndDate/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B09601">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:ParticipationRequestReceptionPeriod/cbc:EndTime"/>
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:ParticipationRequestReceptionPeriod/cbc:EndTime/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B09701">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:TenderingProcess/cac:ParticipationRequestReceptionPeriod/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B09901">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cbc:Description"/>
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cbc:Description/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B10001">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cbc:ProcurementTypeCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B10104">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cac:MainCommodityClassification/cbc:ItemClassificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B10403">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cac:MainCommodityClassification/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cac:AdditionalCommodityClassification/cbc:ItemClassificationCode/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B10703">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cac:AdditionalCommodityClassification/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cac:RealizedLocation/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B11003">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ProcurementProject/cac:RealizedLocation/*">
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProjectLot/cbc:ID/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B11301">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      ...
      <rule context="/ubl:CallForTenders/cac:ProcurementProjectLot/cac:ProcurementProject/cbc:Name/*">
         <assert test="false()" flag="fatal" id="PEPPOL-T024-B11501">Document MUST NOT contain elements not part of the data model.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cac:ProcurementProjectLot/cac:ProcurementProject/*">
