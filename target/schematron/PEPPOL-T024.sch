<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:CallForTenders/cbc:CustomizationID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t024:1'"
                 flag="fatal"
                 id="PEPPOL-T024-B00301">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:t024:1'.</assert>
      </rule>
      <rule context="/ubl:CallForTenders/cbc:ProfileID">
         <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p013'"
                 flag="fatal"
                 id="PEPPOL-T024-B00401">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p013'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:CallForTenders">
        ...
        <assert id="PEPPOL-T024-S301" flag="fatal" test="not(ext:UBLExtensions)"> [PEPPOL-T024-S301] UBLExtensions SHOULD NOT be used.</assert>
      </rule>
      <rule context="ubl:CallForTenders/cbc:UBLVersionID">
      ...
      <rule context="ubl:CallForTenders/cbc:CustomizationID">
        <assert id="PEPPOL-T024-R002"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t024:1'">[PEPPOL-T024-R002] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t024:1'</assert>
      ...
      <rule context="ubl:CallForTenders/cbc:ProfileID">
        <assert id="PEPPOL-T024-R003"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p013'">[PEPPOL-T024-R003] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p013'</assert>
      ...
      <rule context="ubl:CallForTenders/cac:TenderingProcess/cbc:ProcedureCode">
        ...
        <assert id="PEPPOL-T024-R042"
                 flag="fatal"
                 test="(normalize-space(.) = '1' and not(exists(../cac:ParticipationRequestReceptionPeriod))) or (normalize-space(.) != '1')">[PEPPOL-T024-R042] Participation Request Reception Period MUST not be given for proceduretypes without participation contest.</assert>
      </rule>
      ...
      <rule context="ubl:CallForTenders/cac:TenderingProcess/cbc:ContractingSystemCode">
        ...
        <assert id="PEPPOL-T024-R039"
                 flag="fatal"
                 test="normalize-space(.) = ('1', '2', '3')">[PEPPOL-T024-R039] A Call For Tender is only allowed to use one of the following ContractSystemCodes: 'Public Contract', 'Establishment of a Framework agreement' or 'Setting up a Dynamic Purchasing System'.</assert>
      </rule>
