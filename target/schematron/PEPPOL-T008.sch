    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:EnquiryResponse/cac:RequestorParty/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T008-B01002">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
      ...
      <rule context="/ubl:EnquiryResponse/cac:ResponderParty/cbc:EndpointID">
         ...
         <assert test="not(@schemeID) or (some $code in $cleas satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T008-B01802">Value MUST be part of code list 'Electronic Address Scheme (EAS)'.</assert>
      </rule>
