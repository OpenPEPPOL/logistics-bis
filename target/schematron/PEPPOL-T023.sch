...
>>>>>>> 5769a8c1f4cdb98f28b938e8d5a643d8be06c3fa
      <let name="clICD"
      ...
      <rule context="/ubl:TendererQualificationResponse/cac:QualificationResolution/cbc:AdmissionCode">
         <assert test="(some $code in $clTrueFalse satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T023-B03101">Value MUST be part of code list 'Boolean indicator (OpenPeppol)'.</assert>
      </rule>
    ...
    <pattern>
      ...
      <rule context="ubl:TendererQualificationResponse/cbc:CustomizationID">
		       <assert id="PEPPOL-T023-R015"
                 flag="fatal"
                 test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t023:1.0'">[PEPPOL-T023-R015] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t023:1.0'</assert>
      ...
      <rule context="ubl:TendererQualificationResponse/cbc:ProfileID">
        <assert id="PEPPOL-T023-R017"
                 flag="fatal"
                 test="starts-with(normalize-space(.), 'urn:fdc:peppol.eu:prac:bis:p012:1.0')">ProfileID value MUST start with 'urn:fdc:peppol.eu:prac:bis:p012:1.0'</assert>
